...
Kept deliberately in step with nova-hub's backend/services/nodes_parser.py - the
two read the same files, and a client that rejects what the hub accepts just
blocks a node from starting.
"""
